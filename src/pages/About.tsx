...
const values = [
  { title: "Quality First", desc: "batch is tested in our laboratory to ensure consistency, purity, and effectiveness before dispatch.", icon: <FlaskConical className="w-7 h-7" /> },
